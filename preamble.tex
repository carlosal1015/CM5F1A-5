...
\title{
	...
	Quinta Práctica Dirigida\quad Grupo N$^{\circ}$2
}
...
\date{\today} % 6 de octubre del 2023

\titlegraphic{
	\begin{picture}(0,0)
		\put(-130,80){\makebox(0,0)[rt]{\href{https://www.overleaf.com/read/kftjrjrqzcsk}{\includegraphics[width=2.5cm]{overleaf}}}}
